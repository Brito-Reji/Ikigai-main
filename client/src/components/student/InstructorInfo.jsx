...
const InstructorInfo = ({ instructor }) => {
  ...
  const instructorData = {
    ...
    rating: instructor.averageRating || instructor.rating || 4.8,
    students: instructor.totalStudents || instructor.enrollmentCount || 0,
    courses: instructor.courseCount || instructor.courseTotal || 0,
    reviews: instructor.totalReviews || 0,
    bio:
      instructor.description ||
      "An experienced instructor passionate about teaching and helping students achieve their goals.",
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-semibold text-gray-900">
                  {instructorData.students.toLocaleString()}
                </p>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-semibold text-gray-900">
                  {instructorData.reviews.toLocaleString()}
                </p>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Check out all courses by {instructorData.name}
            </p>
          </div>
