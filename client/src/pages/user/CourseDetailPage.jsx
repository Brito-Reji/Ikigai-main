  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                      <div className="text-2xl font-bold text-green-600 mb-2">
                        {publicCourseDetails.lessonCount}
                      </div>
                      <div className="text-sm text-gray-600">Lessons</div>
                    </div>
                    <div className="text-center p-4 bg-purple-50 rounded-lg">
                      <div className="text-2xl font-bold text-purple-600 mb-2">
                        {publicCourseDetails.chapterCount}
                      </div>
            ...
            {activeTab === "instructor" && (
              <InstructorInfo instructor={publicCourseDetails.instructor} />
            )}
            {activeTab === "reviews" && (
              <CourseReviews course={publicCourseDetails} />
            )}
          </div>
        ...
        <div className="mt-12">
          <RelatedCourses
            currentCourse={publicCourseDetails}
            category={publicCourseDetails.category?.name}
          />
        </div>
      </div>
