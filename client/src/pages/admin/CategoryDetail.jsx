...
const CategoryDetail = () => {
  ...
  const category = catData?.categories?.find(c => c._id === categoryId) || null;

  // courses for this category
  const { data: coursesData, isLoading: coursesLoading } = useAdminCourses({ category: categoryId, limit: 100 });
  const courses = coursesData?.data || [];

  const isLoading = catLoading || coursesLoading;
